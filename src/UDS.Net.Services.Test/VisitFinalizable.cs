        ...
        public void IsFinalizable_ReturnsFalse_WhenAllFormsAreNotFinalized()
        {
            ...
            var visit = CreateVisitWithForms(
                ...
                new List<Form>
                {
                    ...
                    new Form(1, 1, "B8", "B8", false, FormStatus.Finalized, DateTime.Now, "XX", FormLanguage.English, FormMode.InPerson, null, null, null, DateTime.Now, "tester", "", "", false, new B8FormFields()),
                    new Form(1, 1, "B9", "B9", false, FormStatus.Finalized, DateTime.Now, "XX", FormLanguage.English, FormMode.InPerson, null, null, null, DateTime.Now, "tester", "", "", false, new B9FormFields()),
                    new Form(1, 1, "C2", "C2", false, FormStatus.InProgress, DateTime.Now, "XX", FormLanguage.English, FormMode.InPerson, null, null, null, DateTime.Now, "tester", "", "", false, new C2FormFields()),
                    new Form(1, 1, "D1a", "D1a", false, FormStatus.InProgress, DateTime.Now, "XX", FormLanguage.English, FormMode.InPerson, null, null, null, DateTime.Now, "tester", "", "", false, new D1aFormFields()),
                    new Form(1, 1, "D1b", "D1b", false, FormStatus.InProgress, DateTime.Now, "XX", FormLanguage.English, FormMode.InPerson, null, null, null, DateTime.Now, "tester", "", "", false, new D1bFormFields())
                }
            );
