...
namespace UDS.Net.Forms.Models.UDS3
{
    ...
    public class B5 : FormModel
    {
        ...
        [RequiredOnComplete(ErrorMessage = "Delusions is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Hallucinations is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Agitation/aggression is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Depression/dysphoria is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Anxiety is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Elation/euphoria is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Apathy/indifference is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Disinhibition is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Irritability/Lability is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Motor disturbance is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Nighttime behaviors is required.")]
        ...
        [RequiredOnComplete(ErrorMessage = "Appetite/eating is required.")]
