...
namespace UDS.Net.Forms.Models.UDS4
{
    public class A1a : FormModel
    {
        ...
        [NotMapped]
        [RequiredOnComplete(ErrorMessage = "If \"not applicable\" or \"prefer not to answer\" marked, another Response cannot be marked")]
        ...
        [NotMapped]
        [RequiredOnComplete(ErrorMessage = "Both \"Not applicable\" and \"Prefer not to answer\" cannot be marked")]
