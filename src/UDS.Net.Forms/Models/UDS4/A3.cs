...
namespace UDS.Net.Forms.Models.UDS4
{
    ...
    public class A3 : FormModel
    {
        ...
        [RegularExpression("^(0[0-9]|1[0-2]|88|99)$", ErrorMessage = "Codes must be 00-12 88 or 99")]
        [RequiredIf(nameof(DADETPR), "01", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "02", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "03", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "04", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "05", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "06", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "07", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "08", ErrorMessage = "Response required")]
        [RequiredIf(nameof(DADETPR), "09", ErrorMessage = "Response required")]
