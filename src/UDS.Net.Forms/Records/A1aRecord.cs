...
namespace UDS.Net.Forms.Records
{
    public record A1aRecord(Form form)
    {
        ...
        [Name("admina1a")]
        public int? Admin { get; init; } = form.MODE == Services.Enums.FormMode.NotCompleted ? null : form.ADMIN.HasValue ? (int)form.ADMIN.Value : null; // TODO add support for different administration types
