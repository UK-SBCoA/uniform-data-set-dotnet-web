    ...
    public static class DomainToViewModelMapper
    {
        ...
        public static D1 ToVM(this D1FormFields fields, int formId)
        {
            return new D1()
            {
                ...
                NORMCOG = fields.NORMCOG.HasValue ? fields.NORMCOG.Value != 0 : false,
                DEMENTED = fields.DEMENTED.HasValue ? fields.DEMENTED.Value != 0 : false,
                ...
                MCIAPLAN = fields.MCIAPLAN.HasValue ? fields.MCIAPLAN.Value != 0 : false,
                MCIAPATT = fields.MCIAPATT.HasValue ? fields.MCIAPATT.Value != 0 : false,
                MCIAPEX = fields.MCIAPEX.HasValue ? fields.MCIAPEX.Value != 0 : false,
                MCIAPVIS = fields.MCIAPVIS.HasValue ? fields.MCIAPVIS.Value != 0 : false,
                MCINON1 = fields.MCINON1.HasValue ? fields.MCINON1.Value != 0 : false,
                MCIN1LAN = fields.MCIN1LAN.HasValue ? fields.MCIN1LAN.Value != 0 : false,
                MCIN1ATT = fields.MCIN1ATT.HasValue ? fields.MCIN1ATT.Value != 0 : false,
                MCIN1EX = fields.MCIN1EX.HasValue ? fields.MCIN1EX.Value != 0 : false,
                MCIN1VIS = fields.MCIN1VIS.HasValue ? fields.MCIN1VIS.Value != 0 : false,
                MCINON2 = fields.MCINON2.HasValue ? fields.MCINON2.Value != 0 : false,
                MCIN2LAN = fields.MCIN2LAN.HasValue ? fields.MCIN2LAN.Value != 0 : false,
                MCIN2ATT = fields.MCIN2ATT.HasValue ? fields.MCIN2ATT.Value != 0 : false,
                MCIN2EX = fields.MCIN2EX.HasValue ? fields.MCIN2EX.Value != 0 : false,
                MCIN2VIS = fields.MCIN2VIS.HasValue ? fields.MCIN2VIS.Value != 0 : false,
                ...
                OTHBIOM = fields.OTHBIOM.HasValue ? fields.OTHBIOM.Value != 0 : false,
                ...
                CVDIF = fields.CVDIF,
                PREVSTK = fields.PREVSTK.HasValue ? fields.PREVSTK.Value != 0 : false,
                STROKDEC = fields.STROKDEC.HasValue ? fields.STROKDEC.Value != 0 : false,
                ...
                DEPIF = fields.DEPIF,
                DEPTREAT = fields.DEPTREAT.HasValue ? fields.DEPTREAT.Value != 0 : false,
