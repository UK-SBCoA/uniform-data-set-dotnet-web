...
namespace UDS.Net.Forms.Extensions
{
    public static class ViewModelToDomainMapper
    {
        ...
        public static Form ToEntity(this FormModel vm)
        {
            ...
            return new Form(vm.VisitId, vm.Id, vm.Title, vm.Kind, vm.Status, vm.FRMDATE, vm.INITIALS, vm.LANG, vm.MODE, vm.RMREAS, vm.RMMODE, vm.NOT, vm.ADMIN, vm.CreatedAt, vm.CreatedBy, vm.ModifiedBy, vm.DeletedBy, vm.IsDeleted, fields);
        }
        ...
        public static IFormFields GetFormFields(this C2 vm, PacketKind packetKind)
        {
            return new C2FormFields
            {
                ...
                VNTPCNC = vm.VNTPCNC,
                RESPVAL = vm.RESPVAL,
                RESPHEAR = vm.RESPHEAR ? true : null,
                RESPDIST = vm.RESPDIST ? true : null,
                RESPINTR = vm.RESPINTR ? true : null,
                RESPDISN = vm.RESPDISN ? true : null,
                RESPFATG = vm.RESPFATG ? true : null,
                RESPEMOT = vm.RESPEMOT ? true : null,
                RESPASST = vm.RESPASST ? true : null,
                RESPOTH = vm.RESPOTH ? true : null,
