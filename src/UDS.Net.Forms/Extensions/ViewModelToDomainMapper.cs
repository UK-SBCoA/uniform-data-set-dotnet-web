    ...
    public static class ViewModelToDomainMapper
    {
        ...
        public static Form ToEntity(this D1 vm)
        {
            var fields = new D1FormFields
            {
                ...
                NORMCOG = vm.NORMCOG ? 1 : 0,
                DEMENTED = vm.DEMENTED ? 1 : 0,
                ...
                MCIAPLAN = vm.MCIAPLAN ? 1 : 0,
                MCIAPATT = vm.MCIAPATT ? 1 : 0,
                MCIAPEX = vm.MCIAPEX ? 1 : 0,
                MCIAPVIS = vm.MCIAPVIS ? 1 : 0,
                MCINON1 = vm.MCINON1 ? 1 : 0,
                MCIN1LAN = vm.MCIN1LAN ? 1 : 0,
                MCIN1ATT = vm.MCIN1ATT ? 1 : 0,
                MCIN1EX = vm.MCIN1EX ? 1 : 0,
                MCIN1VIS = vm.MCIN1VIS ? 1 : 0,
                MCINON2 = vm.MCINON2 ? 1 : 0,
                MCIN2LAN = vm.MCIN2LAN ? 1 : 0,
                MCIN2ATT = vm.MCIN2ATT ? 1 : 0,
                MCIN2EX = vm.MCIN2EX ? 1 : 0,
                MCIN2VIS = vm.MCIN2VIS ? 1 : 0,
                ...
                CVD = vm.CVD ? 1 : 0,
                CVDIF = vm.CVDIF,
                PREVSTK = vm.PREVSTK ? 1 : 0,
                STROKDEC = vm.STROKDEC ? 1 : 0,
                STKIMAG = vm.STKIMAG,
                INFNETW = vm.INFNETW,
                INFWMH = vm.INFWMH,
