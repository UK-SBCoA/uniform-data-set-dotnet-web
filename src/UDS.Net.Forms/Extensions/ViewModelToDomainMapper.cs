    ...
    public static class ViewModelToDomainMapper
    {
        ...
        public static Form ToEntity(this A1 vm)
        {
            var fields = new A1FormFields
            {
                ...
                RACEWHITE = vm.RACEWHITE,
                ETHGERMAN = vm.ETHGERMAN,
                ETHIRISH = vm.ETHIRISH,
                ETHENGLISH = vm.ETHENGLISH,
                ETHITALIAN = vm.ETHITALIAN,
                ETHPOLISH = vm.ETHPOLISH,
                ETHFRENCH = vm.ETHFRENCH,
                ETHWHIOTH = vm.ETHWHIOTH,
                ETHWHIOTHX = vm.ETHWHIOTHX,
                ETHISPANIC = vm.ETHISPANIC,
                ETHMEXICAN = vm.ETHMEXICAN,
                ETHPUERTO = vm.ETHPUERTO,
                ETHCUBAN = vm.ETHCUBAN,
                ETHSALVA = vm.ETHSALVA,
                ETHDOMIN = vm.ETHDOMIN,
                ETHCOLOM = vm.ETHCOLOM,
                ETHHISOTH = vm.ETHHISOTH,
                ETHHISOTHX = vm.ETHHISOTHX,
                RACEBLACK = vm.RACEBLACK,
                ETHAFAMER = vm.ETHAFAMER,
                ETHJAMAICA = vm.ETHJAMAICA,
                ETHHAITIAN = vm.ETHHAITIAN,
                ETHNIGERIA = vm.ETHNIGERIA,
                ETHETHIOP = vm.ETHETHIOP,
                ETHSOMALI = vm.ETHSOMALI,
                ETHBLKOTH = vm.ETHBLKOTH,
                ETHBLKOTHX = vm.ETHBLKOTHX,
                RACEASIAN = vm.RACEASIAN,
                ETHCHINESE = vm.ETHCHINESE,
                ETHFILIP = vm.ETHFILIP,
                ETHINDIA = vm.ETHINDIA,
                ETHVIETNAM = vm.ETHVIETNAM,
                ETHKOREAN = vm.ETHKOREAN,
                ETHJAPAN = vm.ETHJAPAN,
                ETHASNOTH = vm.ETHASNOTH,
                ETHASNOTHX = vm.ETHASNOTHX,
                RACEAIAN = vm.RACEAIAN,
                RACEAIANX = vm.RACEAIANX,
                RACEMENA = vm.RACEMENA,
                ETHLEBANON = vm.ETHLEBANON,
                ETHIRAN = vm.ETHIRAN,
                ETHEGYPT = vm.ETHEGYPT,
                ETHSYRIA = vm.ETHSYRIA,
                ETHMOROCCO = vm.ETHMOROCCO,
                ETHISRAEL = vm.ETHISRAEL,
                ETHMENAOTH = vm.ETHMENAOTH,
                ETHMENAOTX = vm.ETHMENAOTX,
                RACENHPI = vm.RACENHPI,
                ETHHAWAII = vm.ETHHAWAII,
                ETHSAMOAN = vm.ETHSAMOAN,
                ETHCHAMOR = vm.ETHCHAMOR,
                ETHTONGAN = vm.ETHTONGAN,
                ETHFIJIAN = vm.ETHFIJIAN,
                ETHMARSHAL = vm.ETHMARSHAL,
                ETHNHPIOTH = vm.ETHNHPIOTH,
                ETHNHPIOTX = vm.ETHNHPIOTX,
                RACEUNKN = vm.RACEUNKN,
                GENMAN = vm.GENMAN,
                GENWOMAN = vm.GENWOMAN,
                GENTRMAN = vm.GENTRMAN,
                GENTRWOMAN = vm.GENTRWOMAN,
                GENNONBI = vm.GENNONBI,
                GENTWOSPIR = vm.GENTWOSPIR,
                GENOTH = vm.GENOTH,
                GENOTHX = vm.GENOTHX,
                GENDKN = vm.GENDKN,
                GENNOANS = vm.GENNOANS,
                BIRTHSEX = vm.BIRTHSEX,
                INTERSEX = vm.INTERSEX,
                SEXORNGAY = vm.SEXORNGAY,
                SEXORNHET = vm.SEXORNHET,
                SEXORNBI = vm.SEXORNBI,
                SEXORNTWOS = vm.SEXORNTWOS,
                SEXORNOTH = vm.SEXORNOTH,
                SEXORNOTHX = vm.SEXORNOTHX,
                SEXORNDNK = vm.SEXORNDNK,
                SEXORNNOAN = vm.SEXORNNOAN,
