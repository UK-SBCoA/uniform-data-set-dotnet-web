...
namespace UDS.Net.Forms.Pages.UDS4
{
    public class B4Model : FormPageModel
    {
        ...
        public B4Model(IVisitService visitService, IParticipationService participationService, IPacketService packetService) : base(visitService, participationService, packetService, "B4")
        {
        }
