...
namespace UDS.Net.Forms.Pages.UDS4
{
    public class B5Model : FormPageModel
    {
        ...
        public B5Model(IVisitService visitService, IParticipationService participationService, IPacketService packetService) : base(visitService, participationService, packetService, "B5")
        {
        }
