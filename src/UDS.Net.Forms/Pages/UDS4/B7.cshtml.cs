...
namespace UDS.Net.Forms.Pages.UDS4
{
    public class B7Model : FormPageModel
    {
        ...
        public B7Model(IVisitService visitService, IParticipationService participationService, IPacketService packetService) : base(visitService, participationService, packetService, "B7")
        {
        }
