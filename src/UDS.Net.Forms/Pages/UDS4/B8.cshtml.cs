    ...
    public class B8Model : FormPageModel
    {
        ...
        public Dictionary<string, UIBehavior> GaitUIBehavior = new Dictionary<string, UIBehavior>
        {
            { "0", new UIBehavior {
                ...
                {
                    new UIDisableAttribute("B8.GAITFIND"),
                    new UIDisableAttribute("B8.GAITOTHRX")
                },
            } },
        ...
        // With UI Behaviors, liberally disable
        // We have a workaround for when the user changes their mind and adjusts a grandparent item, disable more than necessary
        public Dictionary<string, UIBehavior> NEUREXAMUIBehavior = new Dictionary<string, UIBehavior>
        {
            ...
            { "1", new UIBehavior { PropertyAttribute = new UIEnableAttribute("B8.NORMNREXAM") } },
            { "2", new UIBehavior { PropertyAttribute = new UIEnableAttribute("B8.NORMNREXAM") } },
            { "3", new UIBehavior { PropertyAttribute = new UIEnableAttribute("B8.NORMNREXAM") } }
        };

        public Dictionary<string, UIBehavior> NORMNREXAMUIBehavior = new Dictionary<string, UIBehavior>
        {
            { "0", new UIBehavior {
                PropertyAttributes = new List<UIPropertyAttributes>
                {
        ...
        {
            { "0", new UIBehavior { PropertyAttributes =
                new List<UIPropertyAttributes>
                {
                    new UIDisableAttribute("B8.SLOWINGFM"),
                    new UIDisableAttribute("B8.TREMREST"),
                    new UIDisableAttribute("B8.TREMPOST"),
            ...
            { "8", new UIBehavior { PropertyAttributes =
                new List<UIPropertyAttributes>
                {
                    new UIDisableAttribute("B8.SLOWINGFM"),
                    new UIDisableAttribute("B8.TREMREST"),
        ...
        public Dictionary<string, UIBehavior> OTHERSIGNUIBehavior = new Dictionary<string, UIBehavior>
        {
            { "0", new UIBehavior { PropertyAttributes =
                new List<UIPropertyAttributes>
                {
        ...
        public B8Model(IVisitService visitService, IParticipationService participationService, IPacketService packetService) : base(visitService, participationService, packetService, "B8")
        {
        }
