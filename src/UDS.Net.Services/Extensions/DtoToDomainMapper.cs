...
namespace UDS.Net.Services.Extensions
{
    public static class DtoToDomainMapper
    {
        ...
        public static PacketSubmissionError ToDomain(this PacketSubmissionErrorDto dto)
        {
            ...
            return new PacketSubmissionError(dto.Id, dto.PacketSubmissionId, dto.FormKind, dto.Message, dto.AssignedTo, packetSubmissionErrorLevel, dto.StatusChangedBy, dto.CreatedAt, dto.CreatedBy, dto.ModifiedBy, dto.DeletedBy, dto.IsDeleted);
        }
