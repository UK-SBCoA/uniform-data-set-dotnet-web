    ...
    public class A1FormFields : IFormFields
    {
        ...
        public A1FormFields(FormDto dto) : this()
        {
            if (dto is A1Dto)
            {
                ...
                this.RACEWHITE = a1Dto.RACEWHITE == 1 ? true : (bool?)null;
                this.ETHGERMAN = a1Dto.ETHGERMAN == 1 ? true : (bool?)null;
                this.ETHIRISH = a1Dto.ETHIRISH == 1 ? true : (bool?)null;
                this.ETHENGLISH = a1Dto.ETHENGLISH == 1 ? true : (bool?)null;
                this.ETHITALIAN = a1Dto.ETHITALIAN == 1 ? true : (bool?)null;
                this.ETHPOLISH = a1Dto.ETHPOLISH == 1 ? true : (bool?)null;
                this.ETHSCOTT = a1Dto.ETHSCOTT == 1 ? true : (bool?)null;
                this.ETHWHIOTH = a1Dto.ETHWHIOTH == 1 ? true : (bool?)null;
                this.ETHWHIOTHX = a1Dto.ETHWHIOTHX;
                this.ETHISPANIC = a1Dto.ETHISPANIC == 1 ? true : (bool?)null;
                this.ETHMEXICAN = a1Dto.ETHMEXICAN == 1 ? true : (bool?)null;
                this.ETHPUERTO = a1Dto.ETHPUERTO == 1 ? true : (bool?)null;
                this.ETHCUBAN = a1Dto.ETHCUBAN == 1 ? true : (bool?)null;
                this.ETHSALVA = a1Dto.ETHSALVA == 1 ? true : (bool?)null;
                this.ETHDOMIN = a1Dto.ETHDOMIN == 1 ? true : (bool?)null;
                this.ETHGUATEM = a1Dto.ETHGUATEM == 1 ? true : (bool?)null;
                this.ETHHISOTH = a1Dto.ETHHISOTH == 1 ? true : (bool?)null;
                this.ETHHISOTHX = a1Dto.ETHHISOTHX;
                this.RACEBLACK = a1Dto.RACEBLACK == 1 ? true : (bool?)null;
                this.ETHAFAMER = a1Dto.ETHAFAMER == 1 ? true : (bool?)null;
                this.ETHJAMAICA = a1Dto.ETHJAMAICA == 1 ? true : (bool?)null;
                this.ETHHAITIAN = a1Dto.ETHHAITIAN == 1 ? true : (bool?)null;
                this.ETHNIGERIA = a1Dto.ETHNIGERIA == 1 ? true : (bool?)null;
                this.ETHETHIOP = a1Dto.ETHETHIOP == 1 ? true : (bool?)null;
                this.ETHSOMALI = a1Dto.ETHSOMALI == 1 ? true : (bool?)null;
                this.ETHBLKOTH = a1Dto.ETHBLKOTH == 1 ? true : (bool?)null;
                this.ETHBLKOTHX = a1Dto.ETHBLKOTHX;
                this.RACEASIAN = a1Dto.RACEASIAN == 1 ? true : (bool?)null;
                this.ETHCHINESE = a1Dto.ETHCHINESE == 1 ? true : (bool?)null;
                this.ETHFILIP = a1Dto.ETHFILIP == 1 ? true : (bool?)null;
                this.ETHINDIA = a1Dto.ETHINDIA == 1 ? true : (bool?)null;
                this.ETHVIETNAM = a1Dto.ETHVIETNAM == 1 ? true : (bool?)null;
                this.ETHKOREAN = a1Dto.ETHKOREAN == 1 ? true : (bool?)null;
                this.ETHJAPAN = a1Dto.ETHJAPAN == 1 ? true : (bool?)null;
                this.ETHASNOTH = a1Dto.ETHASNOTH == 1 ? true : (bool?)null;
                this.ETHASNOTHX = a1Dto.ETHASNOTHX;
                this.RACEAIAN = a1Dto.RACEAIAN == 1 ? true : (bool?)null;
                this.RACEAIANX = a1Dto.RACEAIANX;
                this.RACEMENA = a1Dto.RACEMENA == 1 ? true : (bool?)null;
                this.ETHLEBANON = a1Dto.ETHLEBANON == 1 ? true : (bool?)null;
                this.ETHIRAN = a1Dto.ETHIRAN == 1 ? true : (bool?)null;
                this.ETHEGYPT = a1Dto.ETHEGYPT == 1 ? true : (bool?)null;
                this.ETHSYRIA = a1Dto.ETHSYRIA == 1 ? true : (bool?)null;
                this.ETHIRAQI = a1Dto.ETHIRAQI == 1 ? true : (bool?)null;
                this.ETHISRAEL = a1Dto.ETHISRAEL == 1 ? true : (bool?)null;
                this.ETHMENAOTH = a1Dto.ETHMENAOTH == 1 ? true : (bool?)null;
                this.ETHMENAOTX = a1Dto.ETHMENAOTX;
                this.RACENHPI = a1Dto.RACENHPI == 1 ? true : (bool?)null;
                this.ETHHAWAII = a1Dto.ETHHAWAII == 1 ? true : (bool?)null;
                this.ETHSAMOAN = a1Dto.ETHSAMOAN == 1 ? true : (bool?)null;
                this.ETHCHAMOR = a1Dto.ETHCHAMOR == 1 ? true : (bool?)null;
                this.ETHTONGAN = a1Dto.ETHTONGAN == 1 ? true : (bool?)null;
                this.ETHFIJIAN = a1Dto.ETHFIJIAN == 1 ? true : (bool?)null;
                this.ETHMARSHAL = a1Dto.ETHMARSHAL == 1 ? true : (bool?)null;
                this.ETHNHPIOTH = a1Dto.ETHNHPIOTH == 1 ? true : (bool?)null;
                this.ETHNHPIOTX = a1Dto.ETHNHPIOTX;
                this.RACEUNKN = a1Dto.RACEUNKN == 1 ? true : (bool?)null;
                this.GENMAN = a1Dto.GENMAN == 1 ? true : (bool?)null;
                this.GENWOMAN = a1Dto.GENWOMAN == 1 ? true : (bool?)null;
                this.GENTRMAN = a1Dto.GENTRMAN == 1 ? true : (bool?)null;
                this.GENTRWOMAN = a1Dto.GENTRWOMAN == 1 ? true : (bool?)null;
                this.GENNONBI = a1Dto.GENNONBI == 1 ? true : (bool?)null;
                this.GENTWOSPIR = a1Dto.GENTWOSPIR == 1 ? true : (bool?)null;
                this.GENOTH = a1Dto.GENOTH == 1 ? true : (bool?)null;
                this.GENOTHX = a1Dto.GENOTHX;
                this.GENDKN = a1Dto.GENDKN == 1 ? true : (bool?)null;
                this.GENNOANS = a1Dto.GENNOANS == 1 ? true : (bool?)null;
                this.BIRTHSEX = a1Dto.BIRTHSEX;
                this.INTERSEX = a1Dto.INTERSEX;
                this.SEXORNGAY = a1Dto.SEXORNGAY == 1 ? true : (bool?)null;
                this.SEXORNHET = a1Dto.SEXORNHET == 1 ? true : (bool?)null;
                this.SEXORNBI = a1Dto.SEXORNBI == 1 ? true : (bool?)null;
                this.SEXORNTWOS = a1Dto.SEXORNTWOS == 1 ? true : (bool?)null;
                this.SEXORNOTH = a1Dto.SEXORNOTH == 1 ? true : (bool?)null;
                this.SEXORNOTHX = a1Dto.SEXORNOTHX;
                this.SEXORNDNK = a1Dto.SEXORNDNK == 1 ? true : (bool?)null;
                this.SEXORNNOAN = a1Dto.SEXORNNOAN == 1 ? true : (bool?)null;
