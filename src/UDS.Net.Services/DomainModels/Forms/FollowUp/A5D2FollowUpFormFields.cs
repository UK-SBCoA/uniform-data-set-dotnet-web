...
{
    public class A5D2FollowUpFormFields : IFormFields
    {
        ...
        public A5D2FollowUpFormFields() { }
        public A5D2FollowUpFormFields(FormDto dto) : this()
        {
            if (dto is A5D2Dto)
            {
                ...
                this.DEPRTREAT = a5D2Dto.DEPRTREAT.HasValue ? Convert.ToInt32(a5D2Dto.DEPRTREAT.Value) : (int?)null; //C# 8.0 requires explicit conversion for each side of ternary operator
