...
namespace UDS.Net.Forms.Tests
{
    ...
    public class C2RAVLTests : TestBase
    {
        ...
        public async Task RAVLC2ImmediateNotComplete()
        {
            ...
            await Expect(Page.Locator("span").Filter(new() { HasText = "A value of 95 - 98 or 88 is required for 13a. Total delayed recall when Trial 1 of the Rey Auditory Verbal Learning (Immediate) is 95 - 98" })).ToBeVisibleAsync();
